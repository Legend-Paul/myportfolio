export const projects = [
  {
    title: "Blog App",
    description: `A full-stack blogging application that allows users to create, edit, delete, and view blog posts. 
It features user authentication, responsive design, and a rich text editor for composing posts.`,
    image: "images/projects/bloger.png",
    technologies: ["POSTGRESQL", "EXPRESS", "REACT", "NODEJS", "CSS3"],
    codeLink: "https://github.com/Legend-Paul/blog.git",
    liveLink: "https://legendbloger.onrender.com",
  },
  //     {
  //     title: "File Cloud",
